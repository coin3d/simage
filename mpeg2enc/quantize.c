 ...
 */
int 
simpeg_encode_quant_intra(simpeg_encode_context * context,
                          short int *src, short int *dst, int dc_prec, unsigned char *quant_mat, int mquant)
{
  int i;
  int x, y, d;
...
int 
simpeg_encode_quant_non_intra(simpeg_encode_context * context,
                              short int *src, short int *dst, unsigned char *quant_mat, int mquant)
{
  int i;
  int x, y, d;
  int nzflag;
...
void 
simpeg_encode_iquant_intra(simpeg_encode_context * context,
                           short int *src, short int *dst, int dc_prec, unsigned char *quant_mat, int mquant)
{
  int i, val, sum;
...
void 
simpeg_encode_iquant_non_intra(simpeg_encode_context * context,
                               short int *src, short int *dst, unsigned char *quant_mat, int mquant)
{
  int i, val, sum;
...
static void iquant1_intra(short int *src, short int *dst, int dc_prec, unsigned char *quant_mat, int mquant)
{
  int i, val;
...
static void iquant1_non_intra(short int *src, short int *dst, unsigned char *quant_mat, int mquant)
{
  int i, val;
